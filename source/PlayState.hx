...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// "GLOBAL" SCRIPTS
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['hud', 'script1', 'script2', 'script3', 'script4']; // I don't think I need to explain this 
		...
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['dialogue', 'CamRotate', 'Fly dad', 'modchart', 'script4']; // I don't think I need to explain this 
		for (script in daScripts) {
