...
makeLuaSprite('stageFront', 'stages/CORE/corebg', -1120, -620);
setScrollFactor('stageFront', 1, 1);
addLuaSprite('stageFront', false);

makeLuaSprite('screencore', 'stages/CORE/corebgSCREEN', 0, 0);
setObjectCamera('screencore', 'camhud');
addLuaSprite('screencore', false);

makeAnimatedLuaSprite('amanddica', 'stages/CORE/w2/AMANDDICA', 0 -280, 0 +400)
